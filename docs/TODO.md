...
- [x] Unsigned NSIS/MSI installer artifact job (alpha/dev, no signing; PR/main stay artifact-only)
- [x] Tag-triggered unsigned GitHub Release for testers (`v*` tags, always prerelease)
