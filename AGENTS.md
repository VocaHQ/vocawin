...
- **Notepad / WordPad**: UNICODE `SendInput` can advance the caret and drop glyphs. Those targets prefer clipboard paste with restore and fail closed if paste fails (including copy-to-clipboard); other apps stay SendInput-first.
